...
l    = 0.0315;      % length of pendulum rod
%l    = 0.029;      % length of pendulum rod
...
Pitch = (IMU(:,1));
Roll = ((IMU(:,2)*1.035)+1.5);
Roll(1:265) = Roll(1:265)*0.2;
TIM2_CCR2 = (IMU(:,3));
TIM1_CCR3 = (IMU(:,4));
...
figure(1)
plot(ans.setpoint.Time(100:1500)-3.8, simulation_data1(100:1500),'LineWidth', 1.5);
hold on
plot(ans.setpoint.Time(100:1500)-3.1, Roll(100:1500), 'LineWidth', 1.5)
