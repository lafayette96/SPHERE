...
IMU1 = load('capture50.txt'); %0-35deg No controller
IMU2 = load('capture101.txt'); %0-35deg PID
%IMU2 = load('capture51.txt'); %0-35deg PID
IMU3 = load('capture52.txt'); %0-35deg Fuzzy


%Read values for no controller
Pitch1 =            (IMU1(1:1398,1));
Roll1 =             (IMU1(1:1398,2)+0.75);
