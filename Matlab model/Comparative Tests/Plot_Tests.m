...
IMU1 = load('capture1.txt'); %too big Kp coefficient
%IMU1 = load('capture23.txt'); %0-10deg no controller
%IMU2 = load('capture24.txt'); %0-10deg pid
%IMU3 = load('capture25.txt'); %0-10deg Fuzzy


%Read values for no controller
Pitch1 = (IMU1(1:1398,1));
Roll1 = (IMU1(1:1398,2)+2);
...
legend(' Setpoint' ,' Measured Roll Data - PID controller', ' Measured Roll Data - Fuzzy controller', 'FontSize',20);
grid on
grid minor
...
error1(1:220) = error11(1:220);
error2(1:220) = error22(1:220);
error3(1:220) = error33(1:220);

error1(1:220) = error1(1:220)-1;
error2(1:220) = error2(1:220)-1;
error3(1:220) = error3(1:220)-1;
