...
IMU1 = load('capture30.txt'); %0-20deg no controller
IMU2 = load('capture38.txt'); %0-20deg pid
IMU3 = load('capture35.txt'); %0-20deg Fuzzy
...
Setpoint2(210:1398) = 20;


figure(1)
plot(time, Setpoint2, 'r--', 'LineWidth', 1)
hold on
plot(time, Roll1, 'm');
...
error22 = Setpoint1-Roll2;
error33 = Setpoint1-Roll3;

beg = 280;

error1(beg:1398) = error11(beg:1398);
error2(beg:1398) = error22(beg:1398);
error3(beg:1398) = error33(beg:1398);

error1(beg:1398) = error1(beg:1398)-5;
error2(beg:1398) = error2(beg:1398)-5;
error3(beg:1398) = error3(beg:1398)-5;
